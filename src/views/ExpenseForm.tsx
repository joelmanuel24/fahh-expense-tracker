...
export const ExpenseForm: React.FC<ExpenseFormProps> = ({
  ...
  useEffect(() => {
    const loadFormData = async () => {
      ...
      setPayments(pmList);
      if (pmList.length > 0) setPaymentMethod(pmList[0].name);
  ...
  // Close calculator or labels overlay on browser/hardware back button swipe
  useEffect(() => {
  ...
  const handleAddItemRow = () => {
    ...
    setItems(prev => [
      ...prev,
      { id: `new_${Date.now()}`, description: '', amount: 0, category: defaultCat, splitUser: '' }
    ]);
  };
      ...
      <div className="scroll-content padding-bottom-large">
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="form-group">
            <label className="input-label">Description / Store</label>
          ...
          <div className="form-group flex-row-between">
            ...
            <div className="custom-select-wrapper">
              ...
              <svg fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="select-arrows">
              ...
              {items.map((row, idx) => (
                <div key={row.id || idx} className="item-row" style={{ display: 'flex', flexDirection: 'column', gap: '6px', alignItems: 'stretch' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 32px', gap: '8px', alignItems: 'center' }}>
                    ...
                    <div className="custom-select-wrapper" style={{ padding: '4px 18px 4px 6px', minWidth: 'unset', borderRadius: 'var(--radius-sm)', backgroundColor: 'var(--bg-app)' }}>
                      <select 
                        className="select-field"
                        style={{ fontSize: '11px' }}
                      ...
                      <svg fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="select-arrows" style={{ right: '6px', width: '12px', height: '12px' }}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                      </svg>
                    </div>
                  ...
                  {isKkbActive && (
                    <div className="item-kkb-assignee-row" style={{ display: 'flex', gap: '6px', alignItems: 'center' }}>
